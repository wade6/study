/**
 * Project: study
 * File Created at 2013-5-22下午10:27:30
 */
package com.alibaba.webx.study.my.jdbc;
...
public class JdbcDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 创建数据连接对象
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/ace", "root", "root");
            ...
            statement.executeUpdate( "INSERT INTO user(gmt_create, gmt_modified,username, password)" + " VALUES (now(),now(),'jdbcTest','jdbcTest123' ) ") ;
            ResultSet resultSel = statement.executeQuery( "select * from user" );
            while(resultSel.next()){
                String username = resultSel.getString("username");
